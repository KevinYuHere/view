...
<template>
  <div id="create-container">
    <a-typography-title style="margin-top: 60px;">游辞途说</a-typography-title>
    <a-typography-paragraph>
      在此，您可以亲自利用我们的AI技术将某个指定人设的虚拟人物带入现实中与之对话。
    </a-typography-paragraph>
    <a-typography-paragraph>
      只需输入一段人设作为提示文本，再选择一些设置，我们就可以为您生成对应的智能生命体。相信我们的AI技术能帮助您快速创造属于您自己的数字生命并与之对话。
    </a-typography-paragraph>
    <div class="create-col">
      <div>
        <a-typography-title :level="2">人设文本</a-typography-title>
        <a-typography-paragraph>
          <a-textarea class="choose unit-space" :bordered="false" allow-clear show-count :maxlength="1000"
                      v-model:value="text"
                      placeholder="请在此处输入人设文本" :auto-size="{ minRows: 5, maxRows: 20 }"/>
        </a-typography-paragraph>
      </div>
      <div>
        <a-typography-title :level="2">世界投射</a-typography-title>
        <a-typography-paragraph>
          请选择您可以接受的世界观，AI将在您划定的各选项中选择一个用于设定世界观。
        </a-typography-paragraph>
        <a-typography-paragraph>
          <a-popover title="关于韵脚" trigger="click" placement="topLeft" :overlayStyle="{'max-width': '410px'}">
            ...
            <a-cascader
                ...
                placeholder="请在此处选择世界观，可直接输入关键词进行搜索"
        ...
        <a-typography-title :level="2">选择性格</a-typography-title>
        <a-typography-paragraph>
          请选择您希望的大致性格。如果您不选择，则将采用默认设置。
        </a-typography-paragraph>
        <a-typography-paragraph>
    ...
    <a-typography-title style="margin-top: 60px;">快语漫谈</a-typography-title>
    <div class="create-col">
      <div>
        <a-typography-title :level="2">唤醒记忆</a-typography-title>
        <a-typography-paragraph>
          输入历史或小说中有名的人名后点击下方按钮，AI将为您创作人设。请注意，AI生成的人设可能不会完全符合您的预期，您可能需要手动调整。
        </a-typography-paragraph>
        <a-typography-paragraph>
          <a-button @click="generateLyrics" :disabled="lyricsPercentShow">生成人设</a-button>
        </a-typography-paragraph>
        <a-typography-title :level="3">人设预览</a-typography-title>
        <a-typography-paragraph>
        ...
        <a-typography-paragraph>
          <a-textarea class="choose" :bordered="false" show-count v-model:value="lyrics" placeholder="人设预览"
                      :auto-size="{ minRows: 2, maxRows: 25 }"/>
        </a-typography-paragraph>
      </div>
      <div>
        <a-typography-title :level="2">开始对话</a-typography-title>
        <a-typography-paragraph>
        ...
        <a-typography-paragraph>
          <a-button @click="generateMusic" :disabled="musicPercentShow">开始对话</a-button>
        </a-typography-paragraph>
        <a-typography-paragraph>
